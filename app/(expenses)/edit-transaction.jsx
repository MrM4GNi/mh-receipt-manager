...
import { modifiedUserTransaction, uploadReciept, removeTransaction } from '../../lib/firebase';
...
const EditTransaction = () => {
  ...
  const [category, setCategory] = useState(categorizeExpense(transaction.category));
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      await modifiedUserTransaction(newTransaction);
  ...
  const removeTransac = async () => {
    try {
      setLoading(true);
      const res = await removeTransaction(transaction.timestamp);
